...
from src.data.ner import get_IOB_per_token, CollateManagerExp1, get_features_and_labels_exp7
...
parser.add_argument("--data_dir", type=str, default="featurecache/exp_07", help="dataset")
...
parser.add_argument("--checkpoint_dir", type=str, default="checkpoints/exp_07", help="checkpoint_dir")
parser.add_argument("--project_name", type=str, default="2311_embedIE_07_NER_span_classification_both", help="project_name")
...
for split in ["train", "validation", "test"]:
    ...
    try:
        ...
        features_gen, labels_gen = get_features_and_labels_exp7(model, dataloader_gen)

...
from src.data.ner import get_IOB_per_token, CollateManagerExp1, get_features_and_labels_exp6
...
parser.add_argument("--data_dir", type=str, default="featurecache/exp_06", help="dataset")
parser.add_argument("--batch_size_train", type=int, default=128, help="training batch size")
parser.add_argument("--batch_size_gen", type=int, default=1, help="feature generation batch size")
...
parser.add_argument("--checkpoint_dir", type=str, default="checkpoints/exp_06", help="checkpoint_dir")
parser.add_argument("--project_name", type=str, default="2311_embedIE_06_NER_span_classification_next", help="project_name")
...
for split in ["train", "validation", "test"]:
    ...
    try:
        ...
        features_gen, labels_gen = get_features_and_labels_exp6(model, dataloader_gen)
